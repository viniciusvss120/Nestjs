...
// Parra que essa classe funcione precisamos passr o decorator Injectable, todos os providers cadastrados no modulo precisa de decorator para injetar as dependências.
@Injectable()
